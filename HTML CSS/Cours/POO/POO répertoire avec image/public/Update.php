...
if(isset($_POST['id'], $_POST['image'], $_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['telephone'], $_POST['role'])) {
    $id = $_POST['id'];
    $image = $_POST['image'];
    $nom = $_POST['nom'];
    $prenom = $_POST['prenom'];
    ...
    $message = $user->updateUser($id, $nom, $prenom, $email, $telephone, $image, $role);
    echo $message;
}
...
<div class="form-container">
    <?php if ($utilisateur) : ?>
        <form method="POST">
            ...
            <input type="file" name="image" value="<?php echo htmlspecialchars($utilisateur['image_name']); ?>" require><br>
