...
if (isset($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['telephone'], $_POST['password'], $_POST['image'], $_POST['role'])) {
    $nom = $_POST['nom'];
    $prenom = $_POST['prenom'];
    $email = $_POST['email'];
    ...
    $user = new User();
    $message = $user->createUser($nom, $prenom, $email, $telephone, $password, $image, $role);
    echo $message;
} else {
